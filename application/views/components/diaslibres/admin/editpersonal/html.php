		...
		<div class="profile-user-info profile-user-info-striped">
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span id="nombres"><?php echo form_input($nombres);?></span>
				</div>
			</div>
			<div class="profile-info-row">
				<div class="profile-info-name" for="rut"> Rut: </div>
				<div class="profile-info-value">
					<span id="rut"><?php echo form_input($rut);?></span>
					<span for = "digito_rut" id="digito_rut"><?php echo form_input($digito_rut);?></span>
				</div>
			</div>
			<div class="profile-info-row">
				<div class="profile-info-name" for ="apellido_paterno"> Apellido Paterno: </div>
				<div class="profile-info-value">
					<span id="apellido_paterno"><?php echo form_input($apellido_paterno);?></span>
				</div>
			</div>
			<div class="profile-info-row">
				<div class="profile-info-name" for="apellido_materno"> Apellido Materno: </div>
				<div class="profile-info-value">
					<span id="apellido_materno"><?php echo form_input($apellido_materno);?></span>
				</div>
			</div>
			<div class="profile-info-row">
				<div class="profile-info-name" for="correo"> Correo: </div>
				<div class="profile-info-value">
					<span id="correo"><?php echo form_input($correo);?></span>
				</div>
			</div>
		</div>
	...
	<div class="col-xs-12 col-sm-6">
		...
		<div class="profile-user-info profile-user-info-striped">
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<select class="chosen-select col-md-9" id="inputCargo" name="cargo" data-placeholder="Buscar Cargo">
						<option value="<?php echo($personal['cargo']);?>" selected><?php echo($personal['cargo']);?> </option>
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span id="categoria"><?php echo form_input($categoria);?></span>
				</div>
			</div>
			<div class="profile-info-row">
				<div class="profile-info-name" for="nivel"> Nivel: </div>
				<div class="profile-info-value">
					<span id="nivel"><?php echo form_input($nivel);?></span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<select class="chosen-select col-md-9" id="inputCentro" name="centro" data-placeholder="Buscar Centro">
						<option value="<?php echo($this->data['nombreCentro']);?>" selected><?php echo($this->data['nombreCentro']);?> </option>
			...
			<div class="profile-info-row">
				<div class="profile-info-name" for="reconosimiento"> Reconocimiento: </div>
				<div class="profile-info-value">
					<span id="reconosimiento"><?php echo form_input($reconocimiento);?></span>
				</div>
			</div>
			
			
			
			<!-- Tengo que hacer un select con los tipos de contrato que hay  -->
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<select class="chosen-select col-md-9" id="contrato" name="contrato" data-placeholder="Buscar tipo de Contrato">
						<option value="<?php echo($personal['calidad']);?>" selected><?php echo($personal['calidad']);?> </option>
