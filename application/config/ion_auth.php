 ...
 */
$config['site_title']                 = "Plataforma de Trasformación Digital";       // Site Title, example.com
$config['company_name']               = "Corporación Municipal de Valparaíso";       // Site Title, example.com
$config['admin_email']                = "jortizd@cmvalparaiso.com"; // Admin Email, admin@example.com
$config['default_group']              = '';           // Default group, use name
