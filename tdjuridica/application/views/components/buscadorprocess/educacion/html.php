			...
			<div class="widget-header">
				...
				<div class="widget-toolbar no-border">
					<ul class="nav nav-tabs" id="recent-tab">
						...
						<li>
							<a data-toggle="tab" href="#contratos-tab"><span class="label label-default"> Contratos </span></a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div id="ampliacion-tab" class="tab-pane">
						            ...
						            <tbody>
						                ...
						                <tr>    
						                    ...
						                    <td><?= $indicadores[7][8] ?></td>
												...
												<div id="contratos-tab" class="tab-pane">
							
							<div class="col-xs-6">
								<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						            <thead>
						                <tr>
						                    <th><span class="label label-default"> Tarea: Proceso contratos </span></th>
						                    <th>Cantidad</th>
						                </tr>
						            </thead>
						            <tbody>
						                <tr>
						                    <td>Validación SEP</td>
						                    <td><?= $indicadores[9][0] ?></td>
						                </tr>
						
						                <tr>
						                    <td>Validación Financiamiento</td>
						                    <td><?= $indicadores[9][1] ?></td>
						
						                </tr>
						                
						                <tr>
						                    <td>Validación Área de Educación</td>
						                    <td><?= $indicadores[9][2] ?></td>
						                </tr>
						                
						                <tr>    
						                    <td>Aprobación Sub Directora de Educación</td>
						                    <td><?= $indicadores[9][3] ?></td>
						                </tr>
						                <tr>
						                    <td>Entrega de Carta</td>
						                    <td><?= $indicadores[9][4] ?></td>
						                </tr>
						            </tbody>
						        </table>
							</div>
							...
							<div class="col-xs-6">
								<table class="table table-striped table-bordered" cellspacing="0" width="100%">
						            <thead>
						                <tr>
						                    <th><span class="label label-default"> Tarea: Proceso Reemplazo </span></th>
						                    <th>Cantidad</th>
						                </tr>
						            </thead>
						            <tbody>
						                ...
						                <tr>
						                    <td>Carga de Remuneraciones</td>
						                    <td><?= $indicadores[9][5] ?></td>
						
						                </tr>
						                
						                <tr>
						                    <td>Recepción Establecimiento</td>
						                    <td><?= $indicadores[9][6] ?></td>
						                </tr>
						                
						                <tr>
						                    <td>Confección contrato</td>
						                    <td><?= $indicadores[9][7] ?></td>
						                </tr>
						                
						                <tr>    
						                    <td>Notificación de Rechazo</td>
						                    <td><?= $indicadores[9][8] ?></td>
						                </tr>
						                
						                <tr>    
						                    <td>Solicitud de recorreciión</td>
						                    <td><?= $indicadores[9][9] ?></td>
						                </tr>
						            </tbody>
						        </table>
							</div>
...
<div class="clearfix">
	<div class="pull-left">
		...
		<span class="label label-default"> Procesos de contratos nuevos</span>
	</div>
...
<div class="row">
	<div class="col-sm-12">
		<h3 class="row header smaller lighter blue">
			<span class="col-xs-6"> Mapa de los procesos de educación </span>
		</h3>
		...
		<div id="accordion" class="accordion-style1 panel-group">
			...
			<div class="panel panel-default">
				...
				<div class="panel-collapse collapse" id="collapseOne">
					<div class="panel-body">
						<img src="<?= base_url('assets/images/view/buscadorprocess/educacion/pre.png') ?>" width="100%"  height="auto" alt="mapa proceso reemplazo" />
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-collapse collapse" id="collapseTwo">
					<div class="panel-body">
					    <img src="<?= base_url('assets/images/view/buscadorprocess/educacion/ppe.png') ?>" width="100%"  height="auto" alt="mapa proceso reemplazo" />
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-collapse collapse" id="collapseThree">
					<div class="panel-body">
                        <img src="<?= base_url('assets/images/view/buscadorprocess/educacion/pae.png') ?>" width="100%"  height="auto" alt="mapa proceso reemplazo" />
					</div>
				</div>
			</div>
