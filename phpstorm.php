 ...
 * @property ion_auth       ion_auth                        Autenticador
 * @property view_handler       view_handler                        Constructor de vistas
 * @property message_handler       message_handler                        Constructor de respuestas json
 * @property Library_name       $library_name                        Library description
 * @property Library_name       $library_name                        Library description
 *
 */
